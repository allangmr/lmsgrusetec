<template>
  <div class="flex">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              <div class="leading-none mt-1">
                ...
                <small>por {{ suggestion.from }}</small>
              </div>
            </div>
    ...
    <feather-icon icon="SearchIcon" @click="showFullSearch = true" class="cursor-pointer navbar-fuzzy-search ml-4 pr-5" />
  </div>
</template>
